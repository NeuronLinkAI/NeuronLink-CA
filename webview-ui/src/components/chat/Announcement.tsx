...
const Announcement = ({ version, hideAnnouncement }: AnnouncementProps) => {
	return (
		<div
			...
			<p style={{ margin: "5px 0px" }}>
				We can't wait to see how you'll push Neuron Link Code Agent's potential even further! Share your custom
				modes and join the discussion at{" "}
				<VSCodeLink href="https://www.reddit.com/r/NeuronLinkCA" style={{ display: "inline" }}>
					reddit.com/r/NeuronLinkCA
				</VSCodeLink>
				.
			</p>
		</div>
